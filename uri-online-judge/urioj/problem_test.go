...
var tests = []Problem{
	...
	{ID: 1045, URL: "https://www.urionlinejudge.com.br/judge/en/problems/view/1045", Name: "Triangle Types",
		Description: []Content{TextContent(`Read 3 double numbers (A, B and C) representing the sides of a triangle and arrange them in decreasing order, so that the side A is the biggest of the three sides. Next, determine the type of triangle that they can make, based on the following cases always writing an appropriate message:`), ListContent{ListItem{ListText("if A ≥ B + C, write the message: NAO FORMA TRIANGULO")}, ListItem{ListText("if A² = B² + C², write the message: TRIANGULO RETANGULO")}, ListItem{ListText("if A² > B² + C², write the message: TRIANGULO OBTUSANGULO")}, ListItem{ListText("if A² < B² + C², write the message: TRIANGULO ACUTANGULO")}, ListItem{ListText("if the three sides are the same size, write the message: TRIANGULO EQUILATERO")}, ListItem{ListText("if only two sides are the same and the third one is different, write the message: TRIANGULO ISOSCELES")}}},
		Input:       []Content{TextContent(`The input contains three double numbers, A (0 < A) , B (0 < B) and C (0 < C).`)},
		Output:      []Content{TextContent(`Print all the classifications of the triangle presented in the input.`)},
		Sample: []Content{*generateTable([]string{"Input Samples", "Output Samples"},
			TableData{TextContent("7.0 5.0 7.0")}, TableData{TextContent("TRIANGULO ACUTANGULO\nTRIANGULO ISOSCELES")},
			TableData{TextContent("6.0 6.0 10.0")}, TableData{TextContent("TRIANGULO OBTUSANGULO\nTRIANGULO ISOSCELES")},
			TableData{TextContent("6.0 6.0 6.0")}, TableData{TextContent("TRIANGULO ACUTANGULO\nTRIANGULO EQUILATERO")},
			TableData{TextContent("5.0 7.0 2.0")}, TableData{TextContent("NAO FORMA TRIANGULO")},
			TableData{TextContent("6.0 8.0 10.0")}, TableData{TextContent("TRIANGULO RETANGULO")})},
	},
	{ID: 1048, URL: "https://www.urionlinejudge.com.br/judge/en/problems/view/1048", Name: "Salary Increase",
		Description: []Content{TextContent(`The company ABC decided to give a salary increase to its employees, according to the following table:`), *generateTable([]string{"Salary", "Readjustment Rate"}, TableData{TextContent("0 - 400.00\n400.01 - 800.00\n800.01 - 1200.00\n1200.01 - 2000.00\nAbove 2000.00")}, TableData{TextContent("15%\n12%\n10%\n7%\n4%")}), TextContent("Read the employee's salary, calculate and print the new employee's salary, as well the money earned and the increase percentual obtained by the employee, with corresponding messages in Portuguese, as the below example.")},
		Input:       []Content{TextContent(`The input contains only a floating-point number, with 2 digits after the decimal point.`)},
		Output:      []Content{TextContent(`Print 3 messages followed by the corresponding numbers (see example) informing the new salary, the among of money earned and the percentual obtained by the employee. Note:` + "\n" + `Novo salario:  means "New Salary"` + "\n" + `Reajuste ganho: means "Money earned"` + "\n" + `Em percentual: means "In percentage"`)},
		Sample: []Content{*generateTable([]string{"Input Sample", "Output Sample"},
			TableData{TextContent("400.00")}, TableData{TextContent("Novo salario: 460.00\nReajuste ganho: 60.00\nEm percentual: 15 %")},
			TableData{TextContent("800.01")}, TableData{TextContent("Novo salario: 880.01\nReajuste ganho: 80.00\nEm percentual: 10 %")},
			TableData{TextContent("2000.00")}, TableData{TextContent("Novo salario: 2140.00\nReajuste ganho: 140.00\nEm percentual: 7 %")})},
	},
