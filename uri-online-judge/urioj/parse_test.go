...
func testString(f func(*Problem) string, field string, t *testing.T) {
	for id, p := range tests {
		expect := getField(p, field).String()
		get := f(p.Problem)
		check(strconv.Itoa(id), expect, get, t)
	}
}
...
func TestProblem_Name(t *testing.T) {
	testString((*Problem).Name, "Name", t)
}

func TestProblem_Description(t *testing.T) {
	testStringSlice((*Problem).Description, "Description", t)
}

func TestProblem_Input(t *testing.T) {
	testStringSlice((*Problem).Input, "Input", t)
}

func TestProblem_Output(t *testing.T) {
	testStringSlice((*Problem).Output, "Output", t)
}

func TestProblem_Samples(t *testing.T) {
	for id, p := range tests {
		expect := p.Samples
		get := p.Problem.Samples()
		check(strconv.Itoa(id), expect, get, t)
	}
}
