...
// In this problem, the task is to read a code of a product 1, the
...
// price for one unit of product 2. After this, calculate and show the
// amount to be paid.
...
// and after "R$" symbol. The value must be presented with 2 digits
// after the point.
